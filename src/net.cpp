...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Gamacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"gamacointools.com", "159.89.22.120"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"gamacointools.com", "testnet-seed.gamacointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Gamacoin is probably already running."), addrBind.ToString().c_str());
        else
